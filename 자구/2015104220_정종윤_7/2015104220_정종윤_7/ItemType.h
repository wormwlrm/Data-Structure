...
public:
	...
	*	@return	Return true is two item is same, otherwise 0.
	*/
	bool operator==(const ItemType data);

	/**
	*	@brief	Check if this* is big of same with target by comparing ID.
	*	@pre	Two item was initialized.
	*	@param	data	Target Item
	*	@return	Return true is two item is big or same, otherwise 0.
	*/
	bool operator>(const ItemType data);

	/**
	*	@brief	Check if this* is small of same with target by comparing ID.
	*	@pre	Two item was initialized.
	*	@param	data	Target Item
	*	@return	Return true is two item is small, otherwise 0.
	*/
	bool operator<(const ItemType data);

...
public:
	...
	*/
	...
	/**
	*	@brief	Seach item based on primary key and call data.
	*	@pre	ID(primary key) of data must be exist.
	*	@post	If same ID with primary key exists, call data from the list.
	...
	*/
	...
	/**
	*	@brief	Search data by binary search.
	*	@pre	Unsorted data list.
	*	@post	Data list sorted by binary search.
	*	@param	data	Include primary key.
